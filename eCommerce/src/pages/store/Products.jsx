...
const Products = () => {
    ...
    const handleToggleVisibility = async (productId) => {
        try {
            ...
            setPage(1);
            setProducts(prev => prev.map(p => p.id === productId ? { ...p, active: p.active === 0 ? 1 : 0 } : p));
        } catch (err) {
    ...
    }, [storeId, page, searchParams.toString()]);
            ...
            <div className="p-6">
                ...
                {/* <div className="mb-6 flex space-x-2">
                    <button
                        ...
                        className={"px-4 py-2 rounded-lg flex items-center bg-blue-600 text-white"
                    ...
                    >
                        <FaEye className="mr-2" /> Đang hiển thị
                    </button>
                    <button
                    ...
                    >
                        <FaEyeSlash className="mr-2" /> Đang ẩn
                    </button>
                </div> */}
